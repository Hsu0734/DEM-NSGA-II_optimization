...
for row in range(flow_accum_01.configs.rows):
    for col in range(flow_accum_01.configs.columns):
        ...
        if elev_01 == flow_accum_01.configs.nodata:
            ...
            flow_factor_01 = (flow_accum_01[row, col] * 100 * 0.000005701259) ** (2 / 3)
        ...
        if elev_02 == flow_accum_02.configs.nodata:
            ...
            flow_factor_02 = (flow_accum_02[row, col] * 100 * 0.000005701259) ** (2 / 3)
        ...
        if elev_03 == flow_accum_03.configs.nodata:
            ...
            flow_factor_03 = (flow_accum_03[row, col] * 100 * 0.000005701259) ** (2 / 3)
...
# visualization
path_01 = '../00_data_source/min_earth_volume_velocity.tif'
...
path_02 = '../00_data_source/min_flow_length_velocity.tif'
...
path_03 = '../00_data_source/min_velocity_velocity.tif'
